...
export class SuperdoughOutput {
  ...
  initializeAudio() {
    ...
    this.globalAnalyser = audioContext.createAnalyser();
    this.globalAnalyser.fftSize = 2048;
    
    this.channelMerger.connect(this.globalAnalyser);
    this.globalAnalyser.connect(this.destinationGain);
  ...
  disconnect() {
    ...
    this.globalAnalyser.disconnect();
